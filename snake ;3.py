...
# Colors
white = (0, 255, 0) # rgb format
red = (255, 0, 0)
black = (100, 100, 255)
scorecolor = (100, 110, 140)
...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            text_screen("Game Over! Press Enter To Restart :3", red, 100, 250)
            ...
            if abs(snake_x - food_x)<40 and abs(snake_y - food_y)<10:
                score +=1
            ...
            gameWindow.fill(white)
            text_screen("Score: " + str(score * 1), scorecolor, 5, 5)
            pygame.draw.rect(gameWindow, red, [food_x, food_y, snake_size, snake_size])
            pygame.draw.line(gameWindow, scorecolor, (0,40), (900,40),5)
